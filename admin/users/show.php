    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar collapse border-end"
                ...
                <div class="position-sticky">
                    <ul class="nav flex-coloumn pt-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/project/admin/newsletter"
                                style="color: #000000;">
                                <i class="bi bi bi-envelope-paper-fill px-2"></i>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <p>Ini adalah halaman show Pengguna.</p>
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF'] . " ?id=" . $id ?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone"
                                    required value="<?php echo $phone ?>" disabled>
                            </div>
                        </form>
                    </div>
                </div>
