        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/project/admin/newsletter">Category</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h1 class="h2">Category</h2>
                    <p>Ini adalah halaman beranda Category. Anda bisa menambah, mengedit, mengupdate dan menghapus data
                        Category.</p>
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    foreach ($datas as $key => $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td>'.$data['category'].'</td>
                                            <td>
                                                <a href="show.php?id='.$data['id_category'].'" class="btn btn-sm btn-primary button-blue" style="color: white;">Lihat</a>
                                                <a href="edit.php?id='.$data['id_category'].'" class="btn btn-sm btn-primary button-blue" style="color: white;">Edit</a>
                                                <a href="delete.php?id='.$data['id_category'].'" class="btn btn-sm btn-primary" style="color: white;">Hapus</a>
                                            </td>
                                        </tr>   
                                         ';
                                    }
