...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $edit = mysqli_query($conn, "UPDATE category SET category='$category' WHERE id_category='$id_category'");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/project/admin/category">Category</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h1 class="h2">Mengedit Category</h1>
                <p>Ini adalah halaman update Category.</p>
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            $id_category = $_GET['id'];
                            $sql = mysqli_query($conn, "SELECT * FROM category WHERE id_category='$id_category'");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] . " ?id=" . $id_category ?>" method="post">
                            <div class="mb-3">
