...
<?php
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar collapse border-end" style="background-color: #AFEEEE;">
                <div class="position-sticky">
                    <ul class="nav flex-coloumn pt-3">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/project/admin" style="color: #000000;">
                                <i class="bi bi-house-door-fill px-2"></i>
                                <span>Beranda</span>
                            </a>
                        </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/project/admin/users" style="color: #000000;">
                                    <i class="bi bi-person-circle px-2"></i>
                                    <span>User</span>
                                </a>
                            </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="/project/admin/author" style="color: #000000;">
                                            <i class="bi bi-pencil-square px-2"></i>
                                            <span>Author</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="/project/admin/category" style="color: #000000;">
                                            <i class="bi bi-tags-fill px-2"></i>
                                            <span>Category</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/project/admin/news" style="color: #000000;">
                                <i class="bi bi-newspaper px-2"></i>
                                <span>News</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/project/admin/detail-berita" style="color: #000000;">
                                <i class="bi bi-newspaper px-2"></i>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <h1 class="h2">Beranda</h2>
                    <p>Ini adalah halaman beranda admin. Dibawah ini adalah penyajian data statistik berita.</p>


                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 m-lg-0">
                            <div class="card">
                                <h5 class="card-header">Data Berita Terpopuler 2022</h5>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">1</th>
                                                    <td>NCT 127 Gelar Konser “Neo City: The Link” di Bangkok Selama 3 Hari Berturut-Turut</td>
                                                    <td>Entertainment</td>
                                                    <td><a href="#" class="btn btn-sm btn-primary">Lihat</a></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">2</th>
                                                    <td>Pakar Bongkar Identitas Penipu Modus Kurir Kirim Foto: Orang IT</td>
                                                    <td>Technology</td>
                                                    <td><a href="#" class="btn btn-sm btn-primary">Lihat</a></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">3</th>
                                                    <td>Gempa Magnitudo 6,2 Guncang Jember Jatim, Tak Berpotensi Tsunami</td>
                                                    <td>Geography</td>
                                                    <td><a href="#" class="btn btn-sm btn-primary">Lihat</a></td>
                                                </tr>
                                            </tbody>
                        ...
                        <div class="col-12 col-xl-4">
                            <div class="card">
                                <h5 class="card-header">Statistik Berita 2022</h5>
                                <div class="card-body">
    ...
    <script>
        new Chartist.Line('#news-chart', {
            labels: ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun'],
            series: [
                [450, 300, 193, 349, 567, 800]
            ]
        });
    </script>
</body>
