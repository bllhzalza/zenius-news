        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/project/admin/newsletter">News</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h1 class="h2">News</h2>
                    <p>Ini adalah halaman beranda News. Anda bisa menambah, mengedit, mengupdate dan menghapus data
                        News.</p>
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    foreach ($datas as $key => $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td>'.$data['category'].'</td>
                                            <td><img src="image/'.$data['image'].'" width="100"></td>
                                            <td>
                                                <a href="show.php?id='.$data['id_news'].'" class="btn btn-sm btn-primary button-blue" style="color: white;">Lihat</a>
                                                <a href="edit.php?id='.$data['id_news'].'" class="btn btn-sm btn-primary button-blue" style="color: white;">Edit</a>
                                                <a href="delete.php?id='.$data['id_news'].'" class="btn btn-sm btn-primary" style="color: white;">Hapus</a>
                                            </td>
                                        </tr>   
                                         ';
                                    }
