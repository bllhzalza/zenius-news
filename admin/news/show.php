                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] . " ?id=" . $id_news ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Title"
                                    required value="<?php echo $title ?>" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="conclusion" class="form-label">conclusion</label>
                                <input type="text" class="form-control" id="conclusion" name="conclusion"
                                    placeholder="Conclusion" required value="<?php echo $conclusion ?>" disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="category_news" name="category_news"
                                    placeholder="Category" required value="<?php echo $category_news ?>" disabled>
                            </div>
                        </form>
                    </div>
                </div>
