    ...
    if (isset($_POST['logout'])) {
        ...
        include "../../connect.php";
          if (isset($_POST['submit'])) {
            ...
            move_uploaded_file($_FILES['img']['tmp_name'],$direktori.$file_name);

            mysqli_query($conn,"INSERT into detail_news set 
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/project/admin/detail-berita"> Detail Berita</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h1 class="h2">Membuat Detail Berita</h1>
                <p>Ini adalah halaman create  Detail Berita.</p>
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="title_news" class="form-label">Title</label>
                                <input type="text" class="form-control" id="title_news" name="title_news" placeholder="title_news"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="author_news" class="form-label">Nama Author</label>
                                <input type="text" class="form-control" id="author_news" name="author_news"
                                    placeholder="author_news" required>
                            </div>
                            <div class="mb-3">
