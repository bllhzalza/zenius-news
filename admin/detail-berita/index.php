        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/project/admin/detail-news">Detail News</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h1 class="h2">Detail News</h2>
                    <p>Ini adalah halaman beranda Detail News. Anda bisa melihat dan menghapus data
                        Detail News.</p>
                    <div class="card">
                        <div class="card-body">
                        ...
                        Detail News</a>
                            <div class="table-responsive">
                                ...
                                <a href="print.php" class="btn btn-sm btn-primary button-blue" style="color: white;">Unduh</a>
                            </div>
                        </div>
                    </div>
