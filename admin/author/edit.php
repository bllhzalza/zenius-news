...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $edit = mysqli_query($conn, "UPDATE author SET name='$name' WHERE id_author='$id_author'");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/project/admin/author">Author</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h1 class="h2">Mengedit Author</h1>
                <p>Ini adalah halaman update Author.</p>
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            $id_author = $_GET['id'];
                            $sql = mysqli_query($conn, "SELECT * FROM author WHERE id_author='$id_author'");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] . " ?id=" . $id_author ?>" method="post">
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama Author</label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama_author"
                                    required value="<?=$name;?>">
                            </div>
